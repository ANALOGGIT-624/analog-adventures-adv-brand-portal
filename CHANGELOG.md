...
- Allow campaigns to close on the current date by recording the actual close timestamp.
- Add guarded pre-launch editing for fulfillment and production timing.
- Show order-line production instructions and approved proof links in batch cards.
- Expand organizer payout statements with period, gross sales, refunds, deductions, proceeds, and settlement timing.
- Add regression coverage for campaign settings, same-day closing, and proof resolution.
